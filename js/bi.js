...
var _BiStat = {
	record: function(appId, appName, openid, site_id, lng, lat) { // netType网络类型,lng经度,lat纬度
		...
		if (nowDomain == 'cgtest.lightapp.cn' || nowDomain == 'tt.lightapp.cn' || nowDomain == 't.lightapp.cn' || !nowDomain.match(/www.lightapp.cn/i) || !nowDomain.match(/www.liveapp.cn/i) || !nowDomain.match(/liveapp.cn/) || !nowDomain.match(/lightapp.cn/)) {
