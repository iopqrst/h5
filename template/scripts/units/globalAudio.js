...
define(function(require, exports, module) {
	...
	var GlobalAudio = function($item) {
		...
		this._$globalAudio.coffee({
			steams: ['<img src="userfiles/info/musicalNotes.png"/>', '<img src="userfiles/info/musicalNotes.png"/>', '<img src="userfiles/info/musicalNotes.png"/>', '<img src="userfiles/info/musicalNotes.png"/>', '<img src="userfiles/info/musicalNotes.png"/>', '<img src="userfiles/info/musicalNotes.png"/>'],
			steamHeight: 100,
			steamWidth: 50
		});
		...
		//修复ios/android 4.4下音频不播放的问题 (我把document修改成$item，不知道这样会不会影响在其他系统中的问题)
		$(document).one('touchstart', function(e) {
			theClass.audio.play();
		});
//		$item.one('touchstart', function(e) {
//			theClass.audio.play();
//		});
	};
