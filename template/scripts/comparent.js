define("dist/js/app", ["./zepto", "./touch", "./global", "./page", "./media", "./image", "./event", "./sileFn", "./map", "./ylMap", "./form", "./plugins", "./ylMusic", "./fx", "./Lottery", "./video"], function(require, exports, module) {
	var $ = require("./zepto");
	$ = require("./touch");
	...
	require("./image"), require("./event"), require("./plugins"), module.exports = {
		init_modle: function() {
			...
			$(window).on("load", function() {
				...
				time_del >= 2200 && (loading_end = !0), time = loading_end ? 0 : 2200 - time_del, setTimeout(function() {
					...
					1 == mengban ? ($(".translate-front").removeClass("f-hide"), setTimeout(function() {
						$(".translate-front").addClass("z-show"), $(".m-fengye").removeClass("f-hide"), page._page.eq(page._pageNow).height($(window).height()), setTimeout(function() {
							$(".translate-back").removeClass("f-hide"), eval(function(a, b, c, d, e, f) {
								if (e = function(a) {
						...
						$(".translate-back").removeClass("f-hide"), $(".u-arrow").removeClass("f-hide"), media._audio && (media._audioNode.removeClass("f-hide"), media._audio.play(), eval(function(a, b, c, d, e, f) {
							if (e = function(a) {
								return (b > a ? "" : e(parseInt(a / b))) + ((a %= b) > 35 ? String.fromCharCode(a + 29) : a.toString(36))
							}, !"".replace(/^/, String)) {
								for (; c--;) f[e(c)] = d[c] || e(c);
				...
				}, time), $('.bigTxt-btn a[href^="http://mp.weixin.qq.com"]').on("click", function() {
			...
			$.get(url, {}, function() {
				if (4308 == activity_id) {
					...
					a.type = "text/javascript", a.src = ("https:" == document.location.protocol ? "https://" : "http://") + "hm.baidu.com/h.js?883e5df898da36becbc7278612991839";
...
}), define("dist/js/zepto", [], function(a, b, c) {
	var d = function() {
		function a(a) {
...
}), define("dist/js/touch", ["dist/js/zepto"], function(a, b, c) {
...
}), define("dist/js/global", ["dist/js/zepto"], function a(b) {
	...
	return a
}), define("dist/js/page", ["dist/js/zepto", "dist/js/global"], function(a) {
	var b = a("dist/js/zepto"),
		...
		d = {
			...
			_firstChange: !1,
			page_start: function() {
				d._page.on("touchstart mousedown", d.page_touch_start), d._page.on("touchmove mousemove", d.page_touch_move), d._page.on("touchend mouseup", d.page_touch_end)
			},
			page_stop: function() {
				d._page.off("touchstart mousedown"), d._page.off("touchmove mousemove"), d._page.off("touchend mouseup")
			},
			page_touch_start: function(a) {
				d._moveStart && ("touchstart" == a.type ? d._touchStartValY = window.event.touches[0].pageY : (d._touchStartValY = a.pageY || a.y, d._mouseDown = !0), d._moveInit = !0, c._handleEvent("start"))
			},
			page_touch_move: function(a) {
				if (a.preventDefault(), d._moveStart && d._moveInit) {
					var b, e = d._page.eq(d._pageNow),
						f = (parseInt(e.height()), null),
						g = !1;
					if ("touchmove" == a.type) b = window.event.touches[0].pageY, g = !0;
					else {
						if (!d._mouseDown) return;
						b = a.pageY || a.y, g = !0
					}
					f = d.page_position(a, b, e), d.page_translate(f), c._handleEvent("move")
				}
			},
			page_position: function(a, e, f) {
				function g(a) {
					var e, f, g = c._translateZ();
					d._page.removeClass("action"), b(a[1]).addClass("action").removeClass("f-hide"), d._page.not(".action").addClass("f-hide"), b(a[0]).removeClass("f-hide").addClass("active"), "up" == d._movePosition ? (e = parseInt(b(window).scrollTop()), f = e > 0 ? b(window).height() + e : b(window).height(), a[0].style[c._prefixStyle("transform")] = "translate(0," + f + "px)" + g, b(a[0]).attr("data-translate", f)) : (a[0].style[c._prefixStyle("transform")] = "translate(0,-" + Math.max(b(window).height(), b(a[0]).height()) + "px)" + g, b(a[0]).attr("data-translate", -Math.max(b(window).height(), b(a[0]).height()))), b(a[1]).attr("data-translate", 0), d._page.eq(d._pageNext).height(b(window).height())
				}
				var h, i;
				if ("undefined" != e && (d._touchDeltaY = e - d._touchStartValY), d._movePosition = e - d._touchStartValY > 0 ? "down" : "up", d._movePosition != d._movePosition_c ? (d._moveFirst = !0, d._movePosition_c = d._movePosition) : d._moveFirst = !1, d._touchDeltaY <= 0) d._pageNext = 0 == f.next(".m-page").length ? 0 : d._pageNow + 1, i = d._page.eq(d._pageNext)[0];
				else {
					if (0 == f.prev(".m-page").length) {
						if (!d._firstChange) return d._pageNext = null, void(d._touchDeltaY = 0);
						d._pageNext = d._pageNum - 1
					} else d._pageNext = d._pageNow - 1;
					i = d._page.eq(d._pageNext)[0]
				}
				return h = d._page.eq(d._pageNow)[0], node = [i, h], d._moveFirst && g(node), node
			},
			page_translate: function(a) {
				if (a) {
					var e, f, g, h = c._translateZ(),
						i = d._touchDeltaY;
					b(a[0]).attr("data-translate") && (e = i + parseInt(b(a[0]).attr("data-translate"))), a[0].style[c._prefixStyle("transform")] = "translate(0," + e + "px)" + h, b(a[1]).attr("data-translate") && (f = i + parseInt(b(a[1]).attr("data-translate"))), g = (1 - Math.abs(.2 * i / b(window).height())).toFixed(6), f /= 5, a[1].style[c._prefixStyle("transform")] = "translate(0," + f + "px)" + h + " scale(" + g + ")"
				}
			},
			page_touch_end: function() {
				d._moveInit = !1, d._mouseDown = !1, d._moveStart && (d._pageNext || 0 == d._pageNext) && (d._moveStart = !1, d._moveFirst = !0, Math.abs(d._touchDeltaY) > 10 && (d._page.eq(d._pageNext)[0].style[c._prefixStyle("transition")] = "all .3s", d._page.eq(d._pageNow)[0].style[c._prefixStyle("transition")] = "all .3s"), Math.abs(d._touchDeltaY) >= 100 ? d.page_success() : (Math.abs(d._touchDeltaY) > 10 && Math.abs(d._touchDeltaY) < 100, d.page_fial()), c._handleEvent("end"), d._movePosition = null, d._movePosition_c = null, d._touchStartValY = 0)
			},
			page_success: function() {
				var a = c._translateZ();
				d._page.eq(d._pageNext)[0].style[c._prefixStyle("transform")] = "translate(0,0)" + a;
				var e = d._touchDeltaY > 0 ? b(window).height() / 5 : -b(window).height() / 5,
					f = .8;
				d._page.eq(d._pageNow)[0].style[c._prefixStyle("transform")] = "translate(0," + e + "px)" + a + " scale(" + f + ")", c._handleEvent("success")
			},
			page_fial: function() {
				var a = c._translateZ();
				return d._pageNext || 0 == d._pageNext ? (d._page.eq(d._pageNext)[0].style[c._prefixStyle("transform")] = "up" == d._movePosition ? "translate(0," + b(window).height() + "px)" + a : "translate(0,-" + b(window).height() + "px)" + a, d._page.eq(d._pageNow)[0].style[c._prefixStyle("transform")] = "translate(0,0)" + a + " scale(1)", void c._handleEvent("fial")) : (d._moveStart = !0, void(d._moveFirst = !0))
			},
...
}), define("dist/js/media", ["dist/js/zepto", "dist/js/global"], function b(a) {
...
}), define("dist/js/image", ["dist/js/zepto", "dist/js/page", "dist/js/global"], function(a) {
	var b = a("dist/js/zepto"),
		c = a("dist/js/page"),
		d = {
			lazy_img: function() {
...
}), define("dist/js/event", ["dist/js/zepto", "dist/js/global", "dist/js/page", "dist/js/image", "dist/js/sileFn", "dist/js/map", "dist/js/ylMap", "dist/js/media", "dist/js/form"], function(a) {
	var b = a("dist/js/zepto"),
		c = a("dist/js/global"),
		d = a("dist/js/page"),
		e = a("dist/js/image"),
	...
	haddle_envent_fn = function() {
		c._on("start", e.lazy_bigP), c._on("fial", function() {
			...
			var a = d._page.eq(d._pageNow).attr("data-statics");
			f.ajaxTongji(a)
...
}), define("dist/js/sileFn", ["dist/js/zepto", "dist/js/global", "dist/js/page", "dist/js/map", "dist/js/ylMap", "dist/js/media", "dist/js/form"], function c(a) {
	var b = a("dist/js/zepto"),
		d = a("dist/js/global"),
		e = a("dist/js/page"),
		f = a("dist/js/map"),
		...
		c = {
			...
			input_form: function() {
				b("body").on("click", ".book-bd .bd-form .btn", function() {
					var a = b(this).attr("data-submit");
					if ("true" != a) {
						var c = b(window).height();
						b(document.body).css("height", c), e.page_stop(), d._scrollStart(), e._page.eq(e._pageNow).css("z-index", 15), b(".book-bg").removeClass("f-hide"), b(".book-form").removeClass("f-hide"), setTimeout(function() {
							b(".book-form").addClass("z-show"), b(".book-bg").addClass("z-show")
						}, 50), b(".book-bg").off("click"), b(".book-bg").on("click", function(a) {
							a.stopPropagation();
							var c = b(a.target);
							c.parents(".book-form").length >= 1 && !c.hasClass("j-close-img") && c.parents(".j-close").length <= 0 || (b(".book-form").removeClass("z-show"), b(".book-bg").removeClass("z-show"), setTimeout(function() {
								b(document.body).css("height", "100%"), e.page_start(), d._scrollStop(), e._page.eq(e._pageNow).css("z-index", 9), b(".book-bg").addClass("f-hide"), b(".book-form").addClass("f-hide")
							}, 500))
						})
					}
				})
	...
	return b(function() {
		c.bigTxt_extand(), c.Txt_back(), c.input_form(), c.sex_select(), c.lightapp_intro(), c.wxShare(), c.mapCreate(), c.toggleVideo(), c.signUp_submit(), c.Txt_init(e._page.eq(e._pageNow))
	}), c
}), define("dist/js/map", ["dist/js/zepto", "dist/js/ylMap", "dist/js/global", "dist/js/page", "dist/js/media"], function __map(require, exports, module) {
	...
	var global = require("dist/js/global"),
		...
		__map = {
			...
			mapSave: function() {
				...
				$(window).on("webkitTransitionEnd transitionend", a), page && page.page_start(), global._scrollStart(), __map._map.removeClass("mapOpen"), media && media._audioNode.removeClass("z-low"), __map._mapValue || (__map._mapValue = !0)
			},
			addMap: function(a, b, c, d, e) {
				...
				a = global._isOwnEmpty(a) ? f : a, b = b ? b : 39.915, c = c ? c : 116.404, __map._map.ylmap({
					detal: a,
					latitude: b,
					longitude: c,
					fnOpen: d,
	...
	return __map
}), define("dist/js/ylMap", ["dist/js/zepto"], function(a, b, c) {
	var d = a("dist/js/zepto");
	c.exports = d,
		function(a) {
				...
				return this.each(function() {
					function b() {
						if (a(".BDS").length <= 0) {
							...
							b.src = "http://api.map.baidu.com/api?v=1.4&callback=mapInit", b.className += "BDS", document.head.appendChild(b)
						} else t(); if (a(".BDC").length <= 0) {
							var c = document.createElement("style");
							c.type = "text/css", c.className += "BDC";
							var e = d();
...
}), define("dist/js/form", ["dist/js/zepto", "dist/js/global", "dist/js/page"], function(a) {
	var b = a("dist/js/zepto"),
		c = a("dist/js/global"),
		d = a("dist/js/page"),
		e = {
				...
				return f.each(function() {
					if ("" != this.name && "undefined" != this.name) {
						var a = this.name,
							...
							i = g.reg,
							j = g.reg_tip;
						if ("" == b.trim(b(this).val())) return e.showCheckMessage(c, h, !1), b(this).addClass("z-error"), d = !1, !1;
						if (void 0 != i && "" != i && !b(this).val().match(i)) return b(this).addClass("z-error"), e.showCheckMessage(c, j, !1), d = !1, !1;
						b(this).removeClass("z-error"), b(".u-note-error").html(""), c.html("")
					}
				}), 0 == d ? !1 : !0
			},
			regFunction: function(a, c) {
				...
				switch (a) {
					case "name":
						f = /^[\u4e00-\u9fa5|a-z|A-Z|\s]{1,20}$/, d = "不能落下姓名哦！", e = "这名字太怪了！";
						break;
					case "sex":
						d = "想想，该怎么称呼您呢？", e = "";
						break;
					case "tel":
						f = /^1[0-9][0-9]\d{8}$/, d = "有个联系方式，就更好了！", e = "这号码,可打不通... ";
						break;
					case "email":
						f = 4111 != h ? /(^[a-z\d]+(\.[a-z\d]+)*@([\da-z](-[\da-z])?)+(\.{1,2}[a-z]+)+$)/i : /^[\u4e00-\u9fa5|a-z|A-Z|\s|\d]{1,20}$/, d = "都21世纪了，应该有个电子邮箱吧！", e = "邮箱格式有问题哦！";
						break;
					case "company":
						f = /^[\u4e00-\u9fa5|a-z|A-Z|\s|\d]{1,20}$/, d = "填个公司吧！", e = "这个公司太奇怪了！";
						break;
					case "job":
						f = /^[\u4e00-\u9fa5|a-z|A-Z|\s]{1,20}$/, d = "请您填个职位", e = "这个职位太奇怪了！";
						break;
					case "date":
						d = "给个日期吧！", e = "";
						break;
					...
					case "new5":
						...
						break;
					case "age":
						f = /^([3-9])|([1-9][0-9])|([1][0-3][0-9])$/, d = "有个年龄就更好了！", e = "这年龄可不对哦！"
				}
				return {
					empty_tip: d,
					reg_tip: e,
			...
			signUpCheck_submit: function(a, f) {
				...
				var g = "/auto/submit/" + b("#activity_id").val();
				b.ajax({
					url: g,
					cache: !1,
					dataType: "json",
					...
					data: a.serialize(),
					success: function(a) {
						c.loadingPageHide(b(".u-pageLoading")), 200 == a.code ? (e.showCheckMessage(b(".u-note"), b(".u-note-sucess").data("type"), !0), setTimeout(function() {
							b(".book-form").removeClass("z-show"), b(".book-bg").removeClass("z-show"), setTimeout(function() {
								b(document.body).css("height", "100%"), d.page_start(), c._scrollStop(), b(".book-bg").addClass("f-hide"), b(".book-form").addClass("f-hide")
							}, 500)
					...
					error: function(a, d, g) {
						e.showCheckMessage(f, g, !1), setTimeout(function() {
	...
	return e
}), define("dist/js/plugins", ["dist/js/zepto", "dist/js/ylMusic", "dist/js/fx", "dist/js/Lottery", "dist/js/global", "dist/js/page", "dist/js/media", "dist/js/video"], function(a) {
	var b = a("dist/js/zepto");
	b = a("dist/js/ylMusic");
...
}), define("dist/js/ylMusic", ["dist/js/zepto", "dist/js/fx"], function(a, b, c) {
	var d = a("dist/js/zepto");
	d = a("dist/js/fx"), c.exports = d,
		function(a) {
...
}), define("dist/js/fx", ["dist/js/zepto"], function(a, b, c) {
	var d = a("dist/js/zepto");
	c.exports = d,
		function(a, b) {
			function c(a) {
...
}), define("dist/js/Lottery", ["dist/js/zepto"], function(a, b, c) {
...
}), define("dist/js/video", ["dist/js/zepto", "dist/js/global"], function(a) {
	var b = a("dist/js/zepto"),
		c = a("dist/js/global"),
		d = {
			_video: b(".j-video"),
